...
def entonces_obtengo_el_resultado_group1(step, esperado):
    ...
    try:
        ...
        pass
    assert esperado == obtenido, 'El resultado esperado es '+str(esperado)+' y el obtenido es '+str(obtenido)
...
def dado_que_ingreso_los_numeros_a_multiplicar_group1_y_group1(step, num1, num2):
